...
public class ToolManifest {
    ...
    @Builder.Default
    private final ToolUninstaller uninstaller = ToolUtils::defaultUninstaller;
    ...
    private static List<ToolManifest> loadAll() {
        return Arrays.asList(
                ...
                new ToolManifestBuilder()
                        ...
                        .installer((xPlane, progressListener) -> installFromDmg(xPlane, "https://csl.x-air.ru/download/src/409", progressListener))
                        .build(),
                ...
                new ToolManifestBuilder()
                        ...
                        .installer((xPlane, progressListener) -> installFromDmg(xPlane, "https://csl.x-air.ru/download/src/362", progressListener))
                        .build(),
                ...
                new ToolManifestBuilder()
                        ...
                        .installer((xPlane, progressListener) -> installFromDmg(xPlane, "https://downloads.opensceneryx.com/OpenSceneryX-Installer-Mac-2.7.0.dmg", progressListener))
                        .build(),
                ...
                new ToolManifestBuilder()
                        ...
                        .installedVersionGetter(MacPlatform::getMacAppVersion)
                        .installer((xPlane, progressListener) -> installFromZip(xPlane, "https://www.x-plane.com/update/installers11/X-Plane11InstallerMac.zip", progressListener))
                        .build()
        );
    }
