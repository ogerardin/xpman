...
class SceneryIniFile12ParserTest extends ParserTest<SceneryPackIniData> {

    @Test
    void testCanParseSceneryIni() throws IOException, URISyntaxException {
        String fileContents = getResourceAsString("/scenery_packs_12.ini");
        ...
        assertThat(result.getItems(), hasItem(new TokenSceneryPackIniItem("*GLOBAL_AIRPORTS*")));
    }
